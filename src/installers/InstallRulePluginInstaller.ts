...
async function uninstallPackageZip(mod: ManifestV2, profile: ImmutableProfile, rule: CoreRuleType): Promise<void> {
    const packageZipRoutes = getAllManagedPaths(rule.rules)
