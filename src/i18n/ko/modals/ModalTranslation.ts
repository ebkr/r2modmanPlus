...
export const ModalTranslation: ModalMessageFormat = {
    failedToSetSteamFolder: {
        ...
        solution: '만약 실행 파일로 지정했는데도 이 오류가 발생한다면, 관리자 권한으로 실행해 주세요.'
    },
    failedToSetTheGameFolder: {
        ...
        solution: '실행 파일을 제대로 선택했는데도 이 오류가 발생한다면, 관리자 권한으로 실행해 주세요.'
    },
    clearingGameDirectory: {
        title: '{gameName} 설치 폴더를 초기화 하는 중입니다',
        waitToLaunchGame: `
    ...
    importLocalMod: {
        ...
        validationMessages: {
            modNameEmpty: '모드 이름은 비어 있어선 안됩니다.',
            authorNameEmpty: '제작자 이름은 비어 있어선 안됩니다.',
            invalidVersion: '주, 부, 및 수 버전은 0보다 큰 정수여야 합니다.',
            nonNumericVersion: '주, 부, 및 수 버전은 모두 숫자여야 합니다.',
            noProfileSelected: '프로필이 선택되지 않았습니다.'
        }
    },
    concerningPackage: {
        title: '{modName} 검토',
        notFound: '이 모드는 기존의 썬더스토어에서 다운로드 되었습니다만, 현재는 더 이상 존재하지 않습니다.',
    ...
    gameRunning: {
        starting: '{gameName}가 시작되고 있습니다.',
        launchingViaSteam: '{gameName}가 스팀을 통해 시작되고 있습니다.',
    ...
    codeExport: {
        title: '프로필 내보내짐',
        description: '코드가 클립보드에 복사되었습니다. 수동으로 다음과 같이 복사할 수도 있습니다:',
        done: '끝내기',
        copied: '클립보드에 복사됨',
    },
    downloadProgress: {
    ...
    downloadModVersionSelect: {
        ...
        content: {
            recommendedDisclaimer: '모든 모드는 최신 버전을 선택하는걸 권장드립니다.',
            outdatedModsAdvice: '오래된 버전을 사용하면 문제가 발생할 수 있습니다.',
        },
        tags: {
            select: '버전을 선택해야 합니다',
            recommended: '{version}는  권장 버전입니다',
            latest: '{version}는 최신 버전입니다',
            outdated: '{version}는 오래된 버전입니다'
        },
        download: '종속성과 함께 설치',
    },
    updateAllInstalledMods: {
        ...
        hasModsToUpdate: {
            ...
            content: {
                ...
                missingDependenciesInstalled: '종속성 모드 또한 설치될 예정입니다.',
                whatWillHappen: '다음 모드들이 다운로드되고 설치될 예정입니다:',
                modUpdatedTo: '{modName}는 다음 버전으로 업데이트 됩니다: {version}',
            },
            updateAll: '전부 업데이트',
        }
    },
    launchType: {
        ...
        auto: {
            ...
            PROTON: '게임이 "Proton" 옵션을 사용하여 시작될 예정입니다.',
        },
        native: {
    ...
    modFilter: {
        title: '모드 카테고리 필터',
        languageDisclaimer: '카테고리는 썬더스토어로부터 제공되며 번역되지 않았습니다.',
        selectors: {
    ...
    createProfile: {
        title: '프로필 생성',
        description: '이 프로필에는 다른 프로필과 독립되어 이 프로필 만의 모드를 저장합니다.',
        tagStates: {
    ...
    renameProfile: {
        title: '프로필 이름 변경',
        content: '이 프로필에는 다른 프로필과 독립되어 이 프로필 만의 모드를 저장합니다.',
        actions: {
            rename: '이름 변경',
        },
        tagStates: {
        ...
        states: {
            ...
            importInProgress: {
                ...
                content: {
                    ...
                    doNotClose: '{appName}를 닫지 말아 주세요.'
                }
            }
        }
    },
    ...
    settingsLoader: {
        ...
        resetDidNotHelp: '로컬에 저장된 설정을 초기화했지만 설정을 불러오는 문제가 해결되지 않았습니다. 더 최신 버전의 모드 매니저가 있다면 설치해 보세요.'
    },
    actions: {
        close: '닫기',
    },
