export default {
    ...
    importing: {
        ...
        versionVMAll: '主要、次要和补丁都必须是数字。',
        versionVM: '主要、次要和补丁必须是大于 0 的整数。',
        profileVM: '未选择配置文件'
    },
    mixins: {
        splash: {
    ...
    settings: {
        view: {
            ...
            values: [
                ...
                '检查所有配置文件中的未使用模组并清除缓存',
                '当前配置文件：{name}',
                '已启用 {0}/{1}',
                '已禁用 {0}/{1}',
                '导出的文件可以与朋友共享，以便快速轻松地获得相同的配置文件',
                '导出的代码可以与朋友共享，以便快速轻松地获得相同的配置文件',
                '有 1 个模组有更新可用',
                '有 {0} 个模组有更新可用',
                '当前：已启用',
                '当前：已禁用（默认）',
    ...
    settingsLoader: {
        ...
        settingsFailed: '加载本地用户设置失败。您可以使用下面的按钮重置设置，但请注意，所有游戏的所有设置都将丢失，且无法撤销。',
        reset: '重置设置',
    ...
    pages: {
        ...
        help: {
            ...
            launchingInfo: '按设计，通过 Steam 启动游戏的体验将是原版（未模组化）。您需要在平台的相关启动参数区域放置相应的参数。对于 Steam，这将位于游戏的属性中。您的当前参数将是：{code}',
            codeElse: '这些参数将在安装 BepInEx 后可用。',
            failStartTitle1: '尝试启动游戏时出现红色框',
            failStartTip1: '阅读红色框底部的建议。',
            failStartTitle2: '我被带到 Steam 商店页面',
            failStartTip2: '那是因为您没有合法拥有游戏。管理器仅支持合法副本。',
            failStartTitle3: '一个文本窗口出现并立即关闭。',
            failStartTip3: '尝试在设置屏幕上运行预加载器修复。',
            failStartTip4: '如果问题持续存在，请强制退出 Steam 并关闭 Steam 启动模组化。',
            modsTitle: '潜在解决方案',
            modsInfo: '最常见的问题通过按照列出的说明精确操作 {link} 解决',
            here: '这里',
            updatingTitle1: '自动更新',
        ...
        manager: {
            ...
            steamIncorrectDirTip2: '如果此错误已出现，但可执行文件正确，请以管理员身份运行。',
            IncorrectDir: '未能设置 {name} 目录',
            IncorrectDirTip1: '可执行文件必须如下："{name}"。',
            IncorrectDirTip2: '如果此错误已出现，但可执行文件正确，请以管理员身份运行。',
        ...
        profiles: {
            adding: '正在添加 {0} 配置文件',
            renaming: '此配置文件将独立于其他配置文件存储其自己的模组。',
            required: '需要配置文件名称',
            available: '“{0}” 可用',
            exist: '“{0}” 已在使用中，或包含无效字符',
            updateTip: '配置文件中的所有内容将被代码/文件中的内容覆盖。',
            selectProfile: '在下方选择一个配置文件：',
            create: '创建',
            updateProfile: '更新配置文件：{0}',
            rename: '重命名',
            updating: '您是要更新现有配置文件还是创建一个新配置文件？',
            importNew: '导入新配置文件',
            updateExisting: '更新现有配置文件',
            importingProfile: '您是如何导入配置文件的？',
            updatingProfile: '您是如何更新您的配置文件的？',
            fromFile: '从文件',
            fromCode: '从代码',
            enterCode: '输入配置文件代码',
            noCode: '您尚未输入代码',
            ...
            import: '导入',
            delete: '删除配置文件',
            deleteTip1: '这将移除此配置文件中安装的所有模组及其配置文件。',
            deleteTip2: '如果这是意外，请单击变暗区域或右上角的十字。',
            deleteTip3: '您确定要删除此配置文件吗？',
            imported: '{0}% 已导入',
            importedTip1: '由于正在下载模组，这可能需要一些时间。',
            importedTip2: '请不要关闭 {0}。',
            loadingFile: '正在加载文件',
            loadingTip: '将出现文件选择窗口。一旦选择了配置文件，可能需要几分钟时间。',
            title: '选择配置文件',
            subtitle: '配置文件有助于轻松管理模组',
            back: '返回游戏选择',
            select: '选择配置文件',
            createNew: '创建新的',
            IU: '导入/更新',
        ...
        splash: {
            notification: '游戏更新可能会破坏模组。如果发布了新更新，请耐心等待。',
            help: '帮助',
            about: '关于',
            FAQ: '常见问题解答',
            offline: '离线继续',
            ...
            back: '返回',
            know: '你知道吗？',
            installTip: '您可以在 {link} 上使用“使用模组管理器安装”按钮与 r2modman 一起使用。',
            exportProfile: '您可以在设置屏幕上导出所选配置文件，可以作为文件或代码。这样很容易与朋友分享您的模组列表！',
            trouble: '遇到麻烦？',
            troubleTip: '在 Thunderstore 模组化 Discord 服务器中发送错误截图。如果没有解决，请随时@我。',
