...
export default class GameManager {
    ...
    private static _gameList = [
        ...
        new Game('Thunderstore Beta', 'ThunderstoreBeta', 'ThunderstoreBeta',
            ...
            GameSelectionDisplayMode.HIDDEN, GameInstanceType.GAME),
        ...
        new Game('Risk of Rain 2 Dedicated Server', 'RiskOfRain2', 'RiskOfRain2Server',
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.SERVER),
        ...
        new Game('Outward', 'Outward', 'Outward',
            ...
            ], "Outward.jpg", GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME),
