...
export default class GameManager {
    ...
    private static _gameList = [
        ...
        new Game("20 Minutes Till Dawn", "20MinutesTillDawn", "20MinutesTillDawn",
            ...
            new StorePlatformMetadata(StorePlatform.OTHER)], "20MinutesTillDawn.jpg",
        ...
        new Game("Enter the Gungeon", "ETG", "EnterTheGungeon",
            ...
            [new StorePlatformMetadata(StorePlatform.STEAM, "311690"), new StorePlatformMetadata(StorePlatform.EPIC_GAMES_STORE, "Garlic"), new StorePlatformMetadata(StorePlatform.OTHER),
            new StorePlatformMetadata(StorePlatform.OTHER)], "EnterTheGungeon.jpg",
        ...
        new Game("Cult of the Lamb", "COTL", "COTL",
            ...
            new StorePlatformMetadata(StorePlatform.OTHER)], "Cotl.jpg",
