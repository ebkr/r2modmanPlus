...
export default class GameManager {
    ...
    private static _gameList = [
        ...
        new Game('Risk of Rain 2 Dedicated Server', 'RiskOfRain2', 'RiskOfRain2Server',
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.SERVER, PackageLoader.BEPINEX, ["ROR2"], 'risk-of-rain2'),
        ...
        new Game('Dyson Sphere Program', 'DysonSphereProgram', 'DysonSphereProgram',
            ...
            ], "DysonSphereProgram.jpg", GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["DSP"], 'dsp'),
        ...
        new Game('Valheim Dedicated Server', 'Valheim', 'ValheimServer',
            ...
            ], "Valheim.jpg", GameSelectionDisplayMode.VISIBLE, GameInstanceType.SERVER, PackageLoader.BEPINEX, [], 'valheim'),
        ...
        new Game('GTFO', 'GTFO', 'GTFO',
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'gtfo'),
        ...
        new Game('Outward Definitive', 'OutwardDe', 'OutwardDe',
            ...
            [
                ...
                new StorePlatformMetadata(StorePlatform.OTHER)
            ], "OutwardDe.jpg", GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'outward'),
        ...
        new Game('TaleSpire', 'TaleSpire', 'TaleSpire',
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["TS"], 'talespire'),
        ...
        new Game("H3VR", "H3VR", "H3VR",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["Hot Dogs, Horseshoes & Hand Grenades", "Hot Dogs, Horseshoes and Hand Grenades"], 'h3vr'),
        ...
        new Game("ROUNDS", "ROUNDS", "ROUNDS",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'rounds'),
        ...
        new Game("Mechanica", "Mechanica", "Mechanica",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'mechanica'),
        ...
        new Game("Muck", "Muck", "Muck",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'muck'),
        ...
        new Game("BONEWORKS", "BONEWORKS", "BONEWORKS",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.MELON_LOADER, ["BW"], 'boneworks'),
        ...
        new Game("Lethal League Blaze", "LethalLeagueBlaze", "LethalLeagueBlaze",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["LLB"], 'lethal-league-blaze'),
        ...
        new Game("Timberborn", "Timberborn", "Timberborn",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["TB"], 'timberborn'),
        ...
        new Game("TABS", "TABS", "TotallyAccurateBattleSimulator",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["Totally Accurate Battle Simulator"], 'totally-accurate-battle-simulator'),
        ...
        new Game("Nickelodeon All‑Star Brawl", "NASB", "NASB",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["Nickelodeon All-Star Brawl", "NASB"], 'nasb'),
        ...
        new Game("Inscryption", "Inscryption", "Inscryption",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'inscryption'),
        ...
        new Game("Starsand", "Starsand", "Starsand",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'starsand'),
        ...
        new Game('Cats are Liquid - A Better Place', 'CatsAreLiquidABP', 'CatsAreLiquidABP',
            ...
            ['calabp', 'cal', 'abp'], 'cats-are-liquid'),
        ...
        new Game('AGAINST', 'AGAINST', 'AGAINST',
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'against'),
        ...
        new Game('Rogue Tower', 'RogueTower', 'RogueTower',
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ['rt'], 'rogue-tower'),
        ...
        new Game('House of the Dying Sun', 'HOTDS', 'HOTDS',
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ['hotds'], 'hotds'),
        ...
        new Game('For The King', 'ForTheKing', 'ForTheKing',
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["ftk"], 'for-the-king'),
        ...
        new Game('Subnautica', 'Subnautica', 'Subnautica',
            ...
            ], "Subnautica.png", GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'subnautica'),
        ...
        new Game('Subnautica: Below Zero', 'SubnauticaBZ', 'SubnauticaBZ',
            ...
            ], 'SubnauticaBelowZero.png', GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["bz", "sbz", "s:bz"], 'belowzero'),
        ...
        new Game("Core Keeper", "CoreKeeper", "CoreKeeper",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["ck"], 'core-keeper'),
        ...
        new Game("Titanfall 2", "Titanfall2", "Titanfall2",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.NORTHSTAR, ["northstar", "ns", "tf2", "tf|2"], 'northstar'),
        ...
        new Game("Peglin", "Peglin", "Peglin",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'peglin'),
        ...
        new Game("V Rising", "VRising", "VRising",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["vrising"], 'v-rising'),
        ...
        new Game("Hard Bullet", "HardBullet", "HardBullet",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.MELON_LOADER, ["hb"], 'hard-bullet'),
        ...
        new Game("20 Minutes Till Dawn", "20MinutesTillDawn", "20MinutesTillDawn",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["mtd", "20mtd"], '20-minutes-till-dawn'),
        ...
        new Game("Green Hell VR", "GreenHellVR", "GreenHellVR",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["ghvr"], 'green-hell-vr'),
        ...
        new Game("VTOL VR", "VTOL_VR", "VTOL_VR",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'vtol-vr'),
        ...
        new Game("Backpack Hero", "BackpackHero", "BackpackHero",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.MELON_LOADER, ["bh", "farlands"], 'backpack-hero'),
        ...
        new Game("Stacklands", "Stacklands", "Stacklands",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'stacklands'),
        ...
        new Game("Enter the Gungeon", "ETG", "EnterTheGungeon",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["etg"], 'enter-the-gungeon'),
        ...
        new Game("Ravenfield", "Ravenfield", "Ravenfield",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["rf"], 'ravenfield'),
        ...
        new Game("Aloft", "Aloft", "Aloft",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'aloft'),
        ...
        new Game("Cult of the Lamb", "COTL", "COTL",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["cotl"], 'cult-of-the-lamb'),
        ...
        new Game("Chrono Ark", "ChronoArk", "ChronoArk",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'chrono-ark'),
        ...
        new Game("BONELAB", "BONELAB", "BONELAB",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.MELON_LOADER, ["BL"], 'bonelab'),
        ...
        new Game("Trombone Champ", "TromboneChamp", "TromboneChamp",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["tc"], 'trombone-champ'),
        ...
        new Game("Rogue : Genesia", "RogueGenesia", "RogueGenesia",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["rg"], 'rogue-genesia'),
        ...
        new Game("Across the Obelisk", "AcrossTheObelisk", "AcrossTheObelisk",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["ato", "ao"], 'across-the-obelisk'),
        ...
        new Game("ULTRAKILL", "ULTRAKILL", "ULTRAKILL",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["uk"], 'ultrakill'),
        ...
        new Game("Ultimate Chicken Horse", "UltimateChickenHorse", "UltimateChickenHorse",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["uch"], 'ultimate-chicken-horse'),
        ...
        new Game("Atrio: The Dark Wild", "AtrioTheDarkWild", "AtrioTheDarkWild",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["adw"], 'atrio-the-dark-wild'),
        ...
        new Game("Brotato", "Brotato", "Brotato",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.GODOT_ML, [], 'brotato'),
        ...
        new Game("Ancient Dungeon VR", "AncientDungeonVR", "AncientDungeonVR",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.ANCIENT_DUNGEON_VR, ["adv"], 'ancient-dungeon-vr'),
        ...
        new Game("RUMBLE", "RUMBLE", "RUMBLE",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.MELON_LOADER, [], 'rumble'),
        ...
        new Game("Dome Keeper", "DomeKeeper", "DomeKeeper",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.GODOT_ML, ["dk"], 'dome-keeper'),
        ...
        new Game("Skul: The Hero Slayer", "SkulTheHeroSlayer", "SkulTheHeroSlayer",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'skul-the-hero-slayer'),
        ...
        new Game("Sons Of The Forest", "SonsOfTheForest", "SonsOfTheForest",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["sotf"], 'sons-of-the-forest'),
        ...
        new Game("The Ouroboros King", "TheOuroborosKing", "TheOuroborosKing",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["tok"], 'the-ouroboros-king'),
        ...
        new Game("Wrestling Empire", "WrestlingEmpire", "WrestlingEmpire",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["we"], 'wrestling-empire'),
        ...
        new Game("Receiver 2", "Receiver2", "Receiver2",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["rec2"], 'receiver-2'),
        ...
        new Game("The Planet Crafter", "ThePlanetCrafter", "ThePlanetCrafter",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["tpc"], 'the-planet-crafter'),
        ...
        new Game("Patch Quest", "PatchQuest", "PatchQuest",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.MELON_LOADER, ["pq"], 'patch-quest'),
        ...
        new Game("Shadows Over Loathing", "ShadowsOverLoathing", "ShadowsOverLoathing",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["sol"], 'shadows-over-loathing'),
        ...
        new Game("West of Loathing", "WestofLoathing", "WestofLoathing",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["wol"], 'west-of-loathing'),
        ...
        new Game("Sun Haven", "SunHaven", "SunHaven",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["sh"], 'sun-haven'),
        ...
        new Game("Wildfrost", "Wildfrost", "Wildfrost",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["wfrst"], 'wildfrost'),
        ...
        new Game("Shadows of Doubt", "ShadowsofDoubt", "ShadowsofDoubt",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["sod"], 'shadows-of-doubt'),
        ...
        new Game("Garfield Kart - Furious Racing", "GarfieldKartFuriousRacing", "GarfieldKartFuriousRacing",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["gkfr"], 'garfield-kart-furious-racing'),
        ...
        new Game("Techtonica", "Techtonica", "Techtonica",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["tt"], 'techtonica'),
        ...
        new Game("Thronefall", "Thronefall", "Thronefall",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["tf"], 'thronefall'),
        ...
        new Game("We Love Katamari REROLL+ Royal Reverie", "WeLoveKatamariRerollRoyalReverie", "WeLoveKatamariRerollRoyalReverie",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["wlkrr"], 'we-love-katamari-reroll-royal-reverie'),
        ...
        new Game(
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["brc"], 'bomb-rush-cyberfunk'),
        ...
        new Game(
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["lbol"], 'touhou-lost-branch-of-legend'),
         ...
         new Game("Wizard With A Gun", "WizardWithAGun", "WizardWithAGun",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, ["wizgun"], 'wizard-with-a-gun'),
        ...
        new Game("Sunkenland", "Sunkenland", "Sunkenland",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'sunkenland'),
        ...
        new Game("Atomicrops", "Atomicrops", "Atomicrops",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'atomicrops'),
        ...
        new Game("Erenshor", "Erenshor", "Erenshor",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'erenshor'),
        ...
        new Game("Last Train Outta' Wormtown", "LastTrainOuttaWormtown", "LastTrainOuttaWormtown",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'last-train-outta-wormtown'),
        ...
        new Game("DREDGE", "Dredge", "Dredge",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'dredge'),
        ...
        new Game("Cities: Skylines II", "CitiesSkylines2", "CitiesSkylines2",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'cities-skylines-ii'),
        ...
        new Game("Lethal Company", "LethalCompany", "LethalCompany",
            ...
            GameSelectionDisplayMode.VISIBLE, GameInstanceType.GAME, PackageLoader.BEPINEX, [], 'lethal-company'),
    ];
