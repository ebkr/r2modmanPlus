...
export default class BindLoaderImpl {
    ...
    static bind() {
        SettingsViewProvider.provide(() => import("../../../../components/settings-components/v2/SettingsView.vue"));
        LocalModListProvider.provide(() => import("../../../../components/views/LocalModList.vue"));
        OnlineModListProvider.provide(() => import("../../../../components/views/OnlineModListWithPanel.vue"));
    }
